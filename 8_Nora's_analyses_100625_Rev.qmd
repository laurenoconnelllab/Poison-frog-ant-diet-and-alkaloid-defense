...
citeproc: true                       # ensure pandoc’s cite processor runs
reference-location: document         # print refs at the end of the doc
reference-section-title: "References"  # visible heading in README
link-citations: true                 # clickable in-text citations
format:
  html: default
  gfm:
...
#| label: table-helper
#| include: false
table_md_or_html <- function(x, ...) {
  # If we are rendering to HTML, use kableExtra styling.
  if (knitr::is_html_output()) {
    # Use kableExtra as you like:
    kableExtra::kbl(x, ...) |>
      kableExtra::kable_classic(full_width = FALSE, html_font = "Cambria")
      # You can still chain row_spec(), column_spec(), etc. here.
  } else {
    # For Markdown/README: plain kable that renders on GitHub.
...
grid.raster(readPNG('Graphical_abstract.png')) 
